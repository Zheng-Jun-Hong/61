    ...
    <div class="es_popup" v-show="popshow">
        <div class="dispatchSelecWrap">
            <div class="dispatch_saved" v-show="savedShow">
                <div class="dispatch_title">暫存 警報 維修派工單</div>
                <div 
                :class="{ lock: addAlertShow }"
                    ...
                    <div class="dis_col">
                        ...
                        <div>
                            <div class="dis_option_wrap">
                                <div>
                                    <div class="discol_title"><i class="el-icon-warning"></i>警報列表</div>
                                    <dispatchCollapse/>
                                </div>
                                <div>
                                    <div class="discol_title"><i class="el-icon-s-opportunity"></i>原因分析</div>
                                    <dispatchCollapse/>
                                </div>
                            </div>
                        </div>
