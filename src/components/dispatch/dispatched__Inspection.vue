    ...
    <div class="es_popup" ref="dispatchNewCase" v-show="popshow">
        <div class="dispatchSelecWrap">
            <div class="dispatch_saved" v-show="savedShow">
                <div class="dispatch_title">已派工 定檢/清洗</div>
                <div class="dispatch_content">
                    ...
                    <div class="dis_col">
                        ...
                        <div>
                            ...
                            class="nostyle table_align_top">
                                ...
                                min-width="280">
                                    <template slot-scope="scope">
                                        ...
                                        <el-popover
                                            ...
                                            trigger="click">
                                                <div
                                                class="table_pop_option"
                                                v-for="reason in scope.row.reasons"
                                                :key="reason.value"
                                                :class="{check: reason.check}"
                                                @click="checkReason(scope.row.checkedReason, reason)">
                                                    {{ reason.value }}
                                                </div>
                                ...
                                min-width="150">
                                    <template slot-scope="scope">
                                        <el-input v-model="scope.row.numberValue"></el-input>
                                    </template>
                                </el-table-column>
                    ...
                    <div class="dis_col">
                        ...
                        <!-- 手寫 -->
                        <div>
                            <div class="discol_title"><i class="el-icon-edit"></i>手寫記錄</div>
                            <div>
                                <el-table 
                                class="nostyle dis_writeInput"
                                :data="repairRecord.records">
                                    ...
                                    min-width="85">
                                        <template slot-scope="scope">
                                            <div class="upload_writeInput el-upload--picture-card">
                                                <el-upload
                                                    action="https://jsonplaceholder.typicode.com/posts/"
                                                    multiple
                                                    ...
                                                    class="esfiles">
                                                        <span 
                                                        slot="reference"
                                                        class="estable_preview"><i class="el-icon-upload"></i></span>
                                                    </div>
                                                </el-upload>
                                            </div>
                                        </template>
                                ...
                                <el-button
                                style="margin: 1rem 0 0"
                                @click="addNewWriteRecord()">新增手寫記錄</el-button>
                            </div>
                        </div>
                    </div>
            ...
            tableRepairRecord: [
                {
                    ...
                    results: false,
                    reasons: [
                        { value: '原因1', check: false },
                        { value: '原因2', check: false },
                        { value: '原因3', check: false },
                        { value: '原因4', check: false },
                    ],
                    checkedReason: [],
                    numberValue: '',
                    note: '',
