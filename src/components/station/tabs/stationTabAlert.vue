        ...
        <div class="station_alert_top">
            ...
            <div class="alert_selector_list">
                ...
                <div style="margin-left: auto !important;">
                    <el-button type="primary">新增派工</el-button>
                </div>
            </div>
...
<style scoped>
.el-cascader-menu:nth-child(1)::before {
    content: "類型";
}

.el-cascader-menu:nth-child(2)::before {
    content: "設備";
}
</style>
...
import selectInverter from "../selectDevice.vue";

export default {
    name: "stationtabalert",
    components: {
        selectInverter,
        timeRangePicker,
    },
    props: {
        stationData: {type: Object, require: true}
    },
    data() {
        return {
            current_page: 1,
    ...
    methods: {
        ...
        alarm_get(){
            ...
            let request_json = {
                ...
                plant: { all: false, ID: [this.stationData.ID], col: [this.stationData.collection]},
