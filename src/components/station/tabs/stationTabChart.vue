...
export default {
    ...
    data() {
        return {
            ...
            reportSelected: [],
            plant_search: "",
            plant_select: {'ID_list': [this.stationData.ID], 'col_list': [this.stationData.collection]},
            date_selection: {},
        };
    },
    methods: {
    ...
    watch: {
        ...
        stationData(){
            this.plant_select = {'ID_list': [this.stationData.ID], 'col_list': [this.stationData.collection]}
        }
    }
};
</script>
