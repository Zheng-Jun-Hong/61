<template>
    <div>
        ...
        <div class="estime_range_pick" style="margin-top: 1.5rem;">
            <!-- 單選本日、本週、本月、本年 -->
            <div class="btn_select_wrapper">
                <el-button
                    size="mini"
...
export default {
    ...
    data() {
        return {
            ...
            mode: 'all',    //會有 today week month year single interval
            date: "",
            startDate: "",
            endDate: "",
            dateRange: [null, null],
    ...
    methods: {
        ...
        searchDateRange() {
            ...
            this.$emit('input', {date_list: [start_date, end_date], mode: this.mode});   //傳遞已選擇的ID到外層
        },
    },
};
</script>
