...
<script>
import timeRangePicker from "../datepicker/timeRangePickerSingle.vue";
    ...
    methods: {
        ...
        history_data_list(){
            ...
            this.axios.post('/all_plant_history_data_list',{
                ...
                const MyPlot = document.getElementById('plot_div_plant')
                MyPlot.innerHTML = ""
                y_title = "發電量(kWh)"
                type = "bar"
        ...
        oneline_download() {
            ...
            //csv title 處理
            let title = document.querySelector("#plot_div_plant text.gtitle").innerHTML
            ...
            var gd = document.getElementById("plot_div_plant")
