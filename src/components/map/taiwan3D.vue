...
<script>
import * as THREE from "../../assets/js/plugin/three.module.js";
import { GLTFLoader } from "../../assets/js/plugin/GLTFLoader.js";
import { OrbitControls } from "../../assets/js/plugin/OrbitControls.js";
import { gsap } from "../../assets/js/plugin/gsap.js";
...
const picked_pin_point_color = 0xff8046; //滑鼠指到的地圖點顏色
