...
import selectInverter from "../components/station/selectDevice.vue";
import selectStation from "../components/station/selectStation_system.vue";
    ...
    methods: {
        ...
        alarm_get(){
            ...
            let request_json = {
                ...
                plant: { all: this.plant_select.all, ID: this.plant_select.ID_list, col: this.plant_select.col_list},
